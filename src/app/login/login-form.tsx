  ...
  return (
    <main className="relative flex min-h-[100dvh] flex-col items-center justify-center bg-black px-5 selection:bg-orange-500/30">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        {/* Grid + noise (same as landing page) */}
      ...
      <div className="relative z-10 w-full max-w-[420px]">
            ...
            <form action={formAction} className="space-y-5">
              ...
              <div>
                <div className="mb-1.5 flex items-center justify-between">
                  ...
                  <button type="button" className="text-xs font-medium text-orange-400/80 transition-colors hover:text-orange-300">
                    Forgot password?
                  </button>
                </div>
                <div className="relative">
              ...
              {/* Submit */}
              <SubmitButton variant="gradient">Sign in</SubmitButton>
            </form>
          </div>
        </div>
        ...
        <div className="animate-fade-up delay-300 mt-6 flex items-center justify-center gap-4">
          {[
            { icon: "M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z", text: "Secure" },
            { icon: "M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z", text: "GDPR Ready" },
            { icon: "M13 10V3L4 14h7v7l9-11h-7z", text: "Free forever" },
          ].map((item) => (
        ...
        <div className="animate-fade-up delay-300 relative my-8">
          ...
          <div className="relative flex justify-center">
            <span className="bg-black px-4 text-xs text-gray-600">New to salonlink.io?</span>
          </div>
        </div>
