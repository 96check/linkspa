  ...
  return (
    <main className="relative flex min-h-[100dvh] flex-col items-center justify-center bg-black px-4 selection:bg-orange-500/30">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -right-40 -top-40 h-[420px] w-[420px] rounded-full bg-orange-600/[0.07] blur-[120px]" />
        <div className="absolute -left-32 bottom-0 h-[350px] w-[350px] rounded-full bg-yellow-500/[0.05] blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="mt-8 text-center">
          ...
          <h1 className="mt-5 text-2xl font-bold text-white">Create your free page</h1>
